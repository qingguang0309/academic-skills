    ...
    { type: "cols", ratio: [11, 9], cols: [
      ...
      { blocks: [
        { type: "bullets", size: 14.5, gap: 0.26, items: [
          { lead: "疾病负担：", text: "PM2.5 归因死亡在我国环境风险因子中居首位，其中约六成为心血管疾病。" },
          { lead: "证据来源：", text: "支撑现行剂量–反应关系的队列多在年均 25 μg m⁻³ 以下的欧美地区；我国 40–80 μg m⁻³ 区间以生态学与横断面研究为主，个体随访证据有限。" },
          { lead: "测量误差：", text: "多数国内队列以城市年均值赋值，这类非差异性误差会把效应估计压低。" },
        ]},
      ]},
    ]},
...
d.page({
  title: "本研究问两件事：曲线形状，以及达标能挽回多少发病",
  blocks: [
...
d.page({
  title: "结局来自死因监测与医保住院两个数据库的链接，不依赖自报",
  blocks: [
    ...
    { type: "cols", ratio: [9, 11], cols: [
      ...
      { blocks: [
        { type: "bullets", size: 14, gap: 0.22, items: [
          ...
          { lead: "统计模型：", text: "Cox 比例风险模型以年龄为时间尺度、按中心分层，关系形状用 4 节点限制性立方样条。" },
        ]},
      ]},
    ]},
  ],
...
d.page({
  title: "曲线在 35 μg m⁻³ 国家二级标准之上仍未见平台",
  blocks: [
...
d.page({
  ...
  blocks: [
    { type: "bullets", gap: 0.3, items: [
      ...
      { lead: "3. 政策梯度：", text: "达国家二级标准可消除约 38% 归因发病，趋近 WHO AQG 可消除 92%；两者之差即标准继续收紧的收益空间。" },
    ]},
...
d.page({
  title: "暴露精度是主要贡献；三处局限尚未完全解决",
  blocks: [
    { type: "bullets", size: 15.5, gap: 0.24, items: [
      { lead: "暴露精度：", text: "以 1 km 个体化暴露替代城市年均值，交叉验证 R² = 0.88，把非差异性测量误差降到可报告的量级。" },
      { lead: "高浓度证据：", text: "补上 40–80 μg m⁻³ 区间的个体随访证据——现有剂量–反应关系几乎全部建立在年均 25 μg m⁻³ 以下的人群上。" },
    ]},
    { type: "cards", cols: 3, items: [
      { title: "局限 · 迁居与暴露变动", text: "以基线地址暴露为主；排除随访期内迁居者后结果未见实质改变" },
      { title: "局限 · 室内暴露", text: "缺个体室内源与通风信息；已用炊事燃料类型作代理变量部分调整" },
      { title: "局限 · 残余混杂", text: "社会经济地位测量有限；E-value 显示需 RR > 1.4 的未测混杂才能解释效应" },
    ]},
  ],
  notes: "主动讲局限并给出已做的缓解措施，比等评审提问更有说服力。三条局限都要说清\"已经做了什么\"。",
});
